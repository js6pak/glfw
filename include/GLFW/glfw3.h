 ...
 *  will be the same as the application bundle's icon.  For more information on
 *  bundles, see the [Bundle Programming Guide][bundle-guide] in the Mac Developer
 *  Library.
 *
 *  [bundle-guide]: https://developer.apple.com/library/mac/documentation/CoreFoundation/Conceptual/CFBundles/
 *
 *  @remark __X11:__ The default icon is specified in the application's desktop file.
 *
 *  @remark __Wayland:__ This only works on compositors implementing the XDG toplevel icon protocol.
